      ...
      <div class="space-y-5 rounded-2xl border border-gray-100 bg-white p-5 shadow-xl">
        ...
        <form @submit.prevent="handleSignIn" class="space-y-3.5">
          ...
          <div class="flex items-center justify-between">
            ...
            <RouterLink to="/forgot-password" class="text-sm font-semibold text-emerald-600 transition hover:text-emerald-700 hover:underline">
              Lupa password?
            </RouterLink>
          </div>
          ...
          <div class="relative">
            ...
            <div class="relative flex justify-center">
              <span class="bg-white px-4 text-sm font-medium text-gray-500">Atau masuk dengan</span>
            </div>
          </div>
        ...
        <div class="border-t border-gray-200 pt-5 text-center">
          <p class="text-sm text-gray-600">
            Belum punya akun?
            <RouterLink to="/sign-up" class="font-semibold text-emerald-600 transition hover:text-emerald-700 hover:underline">
              Daftar sekarang
            </RouterLink>
          </p>
        </div>
